...
class OrderDetailAdapter(val orderDetailList: ArrayList<OrderDetailData>) : RecyclerView.Adapter<OrderDetailAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val history_detail_order_product_model = itemView.findViewById(R.id.history_detail_order_product_model) as TextView
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.history_detail_order_product_model.text = orderDetail.productModel
