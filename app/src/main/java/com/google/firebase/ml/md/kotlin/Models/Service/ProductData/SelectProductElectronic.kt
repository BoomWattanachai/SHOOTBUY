...
class SelectProductElectronic(var listener: getDataComplete): AsyncTask<String, String, String>() {
    ...
    override fun onPostExecute(result: String?) {
        ...
        var gson = Gson()
        var productElectronicData = gson.fromJson(result.toString(),Array<Electronic>::class.java).toList()
        listener.getDataComplete(productElectronicData!!)
    }

    interface getDataComplete {
        fun getDataComplete(jsonString: List<Electronic>)
    }
}