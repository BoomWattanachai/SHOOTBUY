...
//                ImageDownloadTask(imageView, imageSize).execute(product.imageUrl)
                when(product.title)
                {
                    "Coke" -> imageView.setImageResource(R.drawable.coke_no_sugar)
                    "Pepsi" -> imageView.setImageResource(R.drawable.pepsi_max_taste)
                    "Calpis" -> imageView.setImageResource(R.drawable.calpis_lacto)
                    else -> {}
                }
